#problem statment:- There is an integer array nums sorted in non-decreasing order (not necessarily with distinct values).
...
#time Complexity: Average: O(log n) ,Worst case (duplicates): O(n)
